...
public class PostGoActivity extends AppCompatActivity {
                    ...
                    filePath.putFile(urlImage).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                try {
                                    imageBitmap = new Compressor(PostGoActivity.this)
                                            .setMaxHeight(2048)
                                            .setMaxWidth(1080)
                                            .setQuality(100)
                                ...
                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        firebaseFirestore.collection("Posts").add(postmap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(PostGoActivity.this, "Se ha añadido correctamente", Toast.LENGTH_SHORT).show();
                                                    Intent mainIntent = new Intent(PostGoActivity.this, MainGoActivty.class);
                                                    ...
                                                    Toast.makeText(PostGoActivity.this, "Error en el almacenamiento de la base de datos " + error, Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        Toast.makeText(PostGoActivity.this, "Error de subida " + error, Toast.LENGTH_SHORT).show();
