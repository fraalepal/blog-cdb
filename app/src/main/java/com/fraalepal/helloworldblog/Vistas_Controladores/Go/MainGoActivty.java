...
public class MainGoActivty extends AppCompatActivity {
    ...
    private GoFragment javaFragment;
        ...
        if(mAuth.getCurrentUser() != null) {
            ...
            addPostButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(MainGoActivty.this, PostGoActivity.class));
                }
            });
        }
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        if (!task.getResult().exists()) {
                            Intent setupIntent = new Intent(MainGoActivty.this, SetupActivity.class);
                            startActivity(setupIntent);
                        }
                    }
                    else{
                        String error = task.getException().getMessage();
                        Toast.makeText(MainGoActivty.this, "Error"+ error, Toast.LENGTH_SHORT).show();
                    }
    ...
    private void goToLoginActivity() {
        Intent intent = new Intent(MainGoActivty.this, LoginActivity.class);
