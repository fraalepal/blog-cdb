...
public class MainJavascriptActivty extends AppCompatActivity {
    ...
    private JavascriptFragment javaFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mAuth.getCurrentUser() != null) {
            ...
            javaFragment = new JavascriptFragment();
            ...
            addPostButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(MainJavascriptActivty.this, PostJavascriptActivity.class));
                }
            });
        }
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        if (!task.getResult().exists()) {
                            Intent setupIntent = new Intent(MainJavascriptActivty.this, SetupActivity.class);
                            startActivity(setupIntent);
                        }
                    }
                    else{
                        String error = task.getException().getMessage();
                        Toast.makeText(MainJavascriptActivty.this, "Error"+ error, Toast.LENGTH_SHORT).show();
                    }
    ...
    private void goToLoginActivity() {
        Intent intent = new Intent(MainJavascriptActivty.this, LoginActivity.class);
