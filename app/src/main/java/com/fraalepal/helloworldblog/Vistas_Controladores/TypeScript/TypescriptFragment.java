...
public class TypescriptFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        if(firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery = firebaseFirestore.collection("Posts").whereEqualTo("tech", "TypeScript").orderBy("timestamp",Query.Direction.DESCENDING);
