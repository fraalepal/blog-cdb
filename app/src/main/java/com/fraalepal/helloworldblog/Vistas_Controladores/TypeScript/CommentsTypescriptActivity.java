...
public class CommentsTypescriptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseFirestore.collection("Posts/" + postId + "/Comentario")
                .addSnapshotListener(CommentsTypescriptActivity.this, new EventListener<QuerySnapshot>() {
                    @Override
                ...
                firebaseFirestore.collection("Posts/" + postId + "/Comentario").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        if(!task.isSuccessful()){
                            ...
                            Toast.makeText(CommentsTypescriptActivity.this, "Error al comentar : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
