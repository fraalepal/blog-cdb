package com.fraalepal.helloworldblog.Vistas_Controladores.JavaScript;
...
public class PostJavascriptActivity extends AppCompatActivity {
        ...
        newPostImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CropImage.activity()
                        ...
                        .setAspectRatio(16, 9)
                        .start(PostJavascriptActivity.this);
                    ...
                    filePath.putFile(urlImage).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                try {
                                    imageBitmap = new Compressor(PostJavascriptActivity.this)
                                            .setMaxHeight(2048)
                                            .setMaxWidth(1080)
                                            .setQuality(100)
                                ...
                                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        firebaseFirestore.collection("Posts").add(postmap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(PostJavascriptActivity.this, "Se ha añadido correctamente", Toast.LENGTH_SHORT).show();
                                                    Intent mainIntent = new Intent(PostJavascriptActivity.this, MainJavascriptActivty.class);
                                                    ...
                                                    Toast.makeText(PostJavascriptActivity.this, "Error en el almacenamiento de la base de datos " + error, Toast.LENGTH_SHORT).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        ...
                                        Toast.makeText(PostJavascriptActivity.this, "Error de subida " + error, Toast.LENGTH_SHORT).show();
