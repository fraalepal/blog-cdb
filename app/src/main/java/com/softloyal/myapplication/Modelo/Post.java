...
public class Post extends PostId {
    ...
    //Atributos del post
    public String image_url, image_thumb, title, desc, user_id;
    ...
    public Post(String image_url, String image_thumb, String title, String desc, String user_id, Date timestamp) {
